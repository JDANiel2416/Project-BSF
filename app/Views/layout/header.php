<?php
    // Obtiene el path actual para marcar el enlace activo
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>/css/style.css?v=1.2">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
</head>
<body>
<header class="main-header">
    <div class="container">
        <a href="<?php echo BASE_URL; ?>/inicio" class="logo"><img src="<?php echo BASE_URL; ?>/img/logo-bsf.png" alt="Logo Banderas Sin Fronteras"></a>
        <nav class="main-nav">
            <ul>
